...
public class test_figure_2_top_center {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            DistanceExpression crash_probability = new AtomicDistanceExpressionLeq(test_figure_2_top_center::rho_crash_probability);
    ...
    private static  Perturbation getIteratedSlowerPerturbation() {
        return new AfterPerturbation(1, new IterativePerturbation(150, new AtomicPerturbation(TIMER_INIT - 1, test_figure_2_top_center::slowerPerturbation)));
    }
    ...
    private static  Perturbation getIteratedSlowerPerturbation_bis() {
        return new AfterPerturbation(1, new IterativePerturbation(150, new AtomicPerturbation(TIMER_INIT - 1, test_figure_2_top_center::slowerPerturbation_bis)));
    }
    ...
    private static  Perturbation getIteratedSlowerPerturbation_ter() {
        return new AfterPerturbation(1, new IterativePerturbation(150, new AtomicPerturbation(TIMER_INIT - 1, test_figure_2_top_center::slowerPerturbation_ter)));
    }
