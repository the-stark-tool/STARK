 ...
 */
public class TwoLanesTwoCarsAttack {
    ...
    public TwoLanesTwoCarsAttack() throws IOException{
        try {
            ...
            DistanceExpression crash_speed = new AtomicDistanceExpression(TwoLanesTwoCarsAttack::rho_si,(v1, v2)->Math.abs(v1-v2));
            ...
            DistanceExpression crash = new AtomicDistanceExpression(TwoLanesTwoCarsAttack::rho_crash,(v1, v2)->Math.abs(v1-v2));
            ...
            DistanceExpression atomic_r2l = new AtomicDistanceExpression(TwoLanesTwoCarsAttack::rho_r2l,(v1,v2)->Math.abs(v1-v2));
            ...
            DistanceExpression atomic_kir = new AtomicDistanceExpression(TwoLanesTwoCarsAttack::rho_kir,(v1,v2)->Math.abs(v1-v2));
    ...
    private static Perturbation get_reckless_driver(){
        return new AfterPerturbation(5,new IterativePerturbation(50,new AtomicPerturbation(2,TwoLanesTwoCarsAttack::reckless_driver)));
    }
