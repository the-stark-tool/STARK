 ...
 */
public class StarkVariableRegistry {

    private final Map<String, StarkVariable> variables = new HashMap<>();
     ...
     */
    public StarkVariable get(String name) {
     ...
     * @return the variable with the given name.
     */
    public StarkVariable getOrRegister(String name) {
        return variables.computeIfAbsent(name, this::getVariable);
    }


    private StarkVariable getVariable(String name) {
        return new StarkVariable(name, variables.size());
    }
