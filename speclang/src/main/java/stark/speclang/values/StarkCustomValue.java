...
public final class StarkCustomValue implements StarkValue {

    private final StarkCustomType type;

    private final int elementIndex;

    public StarkCustomValue(StarkCustomType type, int elementIndex) {
        this.type = type;
    ...
    public boolean equals(Object o) {
        ...
        StarkCustomValue that = (StarkCustomValue) o;
