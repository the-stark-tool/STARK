...
public class UnboundedReleaseuDisTLFormula implements UDisTLFormula {
    ...
    public <T> DisTLFunction<T> eval(DisTLFormulaVisitor<T> evaluator) {
        throw new UnsupportedOperationException("Semantic evaluation of unbounded release is not formally defined");
    }
